...
import { BroadcastComponent } from 'app/entities/core/broadcast/broadcast.component';
...
describe('Component Tests', () => {
  describe('Broadcast Management Component', () => {
    let comp: BroadcastComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(BroadcastComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.broadcasts[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
